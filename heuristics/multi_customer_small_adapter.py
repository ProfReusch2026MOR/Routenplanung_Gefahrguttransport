...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Explicit charger OD matrix CSV; defaults to "
            "od_matrix_small_charger.csv in --data-dir."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional path for a machine-readable solver warm-start JSON. "
...
def main() -> None:
    ...
    if args.output_json is not None:
        try:
            output_path = export_warm_start_json(
                adapter,
                vns.evaluation,
                args.output_json,
            ...
            raise SystemExit(
                f"Could not write warm-start JSON: {error}"
            ) from error
        print()
        print(f"warm_start_json={output_path}")
